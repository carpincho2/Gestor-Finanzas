...
class ApiService {
  ...
  String get baseUrl {
    // Apuntar a la IP real de la PC de desarrollo para que un dispositivo físico conectado a la misma red pueda acceder.
    if (kIsWeb) return 'http://127.0.0.1:8000';
    if (Platform.isAndroid || Platform.isIOS) return 'http://192.168.100.2:8000';
