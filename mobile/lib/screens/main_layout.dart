...
class _MoreScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = [
      ...
      _MoreOption('Supermercados SEPA', Icons.storefront_outlined, const Color(0xFF14B8A6), () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SupermercadosScreen()))),
