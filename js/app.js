...
function scSaveTicket() {
  ...
  addTransaction({ type:'expense', desc:txDesc, amount, cat, date,
    ...
    list.innerHTML = cards.map(c => `
      <div class="ai-insight-card ai-insight-card--${c.tipo}">
        <div class="ai-insight-card-top">
          ...
          <span class="ai-insight-badge ai-insight-badge--${c.tipo}">${
            c.tipo==='positivo'?'Positivo':c.tipo==='negativo'?'Atención':c.tipo==='alerta'?'⚠ Alerta':'Info'
          }</span>
        </div>
