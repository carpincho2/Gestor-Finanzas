...
def seed_db():
    ...
    try:
        ...
        sucursales_def = [
            ...
            ("S4", comercios_map["C1"].id, "Disco Constitución", -37.9606, -57.5645, "Av. Constitución 6069", "Mar del Plata", "Buenos Aires"),
            ("S5", comercios_map["C3"].id, "Carrefour Market Catamarca", -37.9968, -57.5458, "Catamarca 1965", "Mar del Plata", "Buenos Aires"),
            ("S6", comercios_map["C4"].id, "Toledo Falucho", -38.0030, -57.5500, "Falucho 2007", "Mar del Plata", "Buenos Aires"),
            ("S7", comercios_map["C3"].id, "Carrefour Hiper Constitución", -37.9537, -57.5795, "Av. Constitución 7598", "Mar del Plata", "Buenos Aires"),
            ("S8", comercios_map["C1"].id, "Disco Alberti", -38.0065, -57.5458, "Alberti 2535", "Mar del Plata", "Buenos Aires"),
            ("S15", comercios_map["C4"].id, "Toledo Colón", -38.0089, -57.5398, "Av. Colón 1554", "Mar del Plata", "Buenos Aires"),
            ("S16", comercios_map["C4"].id, "Toledo Güemes", -38.0125, -57.5422, "Avellaneda 1244", "Mar del Plata", "Buenos Aires"),
            ("S17", comercios_map["C5"].id, "Vea Luro", -37.9866, -57.5583, "Av. Pedro Luro 3901", "Mar del Plata", "Buenos Aires"),
            ("S18", comercios_map["C4"].id, "Toledo Constitución", -37.9735, -57.5684, "Av. Constitución 4386", "Mar del Plata", "Buenos Aires"),
